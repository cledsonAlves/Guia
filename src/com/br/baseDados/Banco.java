...
public class Banco {
	...
	private final static String NOME_BANCO = "GuiaJarinu";
	private Cursor c ;
	private Context ctx;
	...
	public Cursor buscaCount(String tabela, String where) {
		c =  db.query(tabela, null, where, null, null, null, null);
		return c;
	...
	public Cursor buscaTotal(String tabela, String[] colunas, String where) {
		c = db.query(tabela, colunas, where, null, null, null, null);
		return c;
	...
	public Cursor buscaDados(String tabela1, String tabela2, String colunas[],
			String where) {
		c = db.query(tabela1 + " INNER JOIN " + tabela2, colunas, where,
				null, null, null, null);
		return c;
	}

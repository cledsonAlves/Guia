...
public class Pizzarias extends Fragment{

	private TextView txtFragmenttwo;
	private ListView lista;
	Adaptador adap;
	 ArrayList<Anuncio> listas;
    public static Pizzarias newInstance() {
        Bundle bundle = new Bundle();

        Pizzarias fragment = new Pizzarias();
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		final View rootView = inflater.inflate(R.layout.two_fragment, container, false);
       ...
       listas = new ArrayList<Anuncio>();
        ...
        listas = mb.getAnuncio("RAMO = '1'");
  
        
        
         adap = new Adaptador(rootView.getContext(), listas);

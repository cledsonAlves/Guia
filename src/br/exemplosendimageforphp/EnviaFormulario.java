...
public class EnviaFormulario extends Activity {
	private WrapData wd;
	...
	// IMG IN SDCARD
		public void sendData(View view){
			...
			wd.setUrl("http://www.desagil.com.br/usuario.php");
					...
					runOnUiThread(new Runnable(){
						public void run(){
							...
							try{
								...
								Toast.makeText(EnviaFormulario.this, answer, Toast.LENGTH_SHORT).show();
							}
